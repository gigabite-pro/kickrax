...
const features = [
  {
    ...
    description: 'Search across StockX, GOAT, eBay Canada, Kijiji, and Grailed simultaneously.',
  },
  {
    icon: DollarSign,
    title: 'CAD Pricing',
  ...
  },
  {
    ...
    description: 'Fresh prices fetched on every search, no stale data.',
  },
  {
    icon: Shield,
    title: 'Public Data Only',
    description: 'We only access publicly available listing information.',
  },
  {
    icon: MapPin,
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-drip-silver text-lg leading-relaxed mb-4">
              Finding the best price for a sneaker is exhausting. You have to check StockX, then GOAT, then eBay, then Kijiji... and by the time you&apos;ve compared everything, the deal might be gone.
            </p>
          ...
          >
            ...
            <p className="text-drip-silver text-lg leading-relaxed">
              DripStock searches 5+ platforms simultaneously and shows you every listing in Canadian dollars. We group similar sneakers together so you can instantly see who has the best price. It&apos;s like Skyscanner or Google Flights, but for sneakers.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-drip-silver text-lg leading-relaxed mb-6">
              We aggregate publicly available data from the following platforms:
            </p>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {['StockX', 'GOAT', 'eBay Canada', 'Kijiji', 'Grailed'].map((source) => (
                <div
                  key={source}
