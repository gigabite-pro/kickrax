...
// Popular sneakers that are commonly searched
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {trendingSneakers.map((sneaker, index) => (
              ...
              >
                <Link
                  href={`/?search=${encodeURIComponent(sneaker.name)}`}
                  className="glass rounded-xl p-5 flex items-center justify-between gap-4 hover:bg-drip-charcoal/80 transition-colors group"
                >
